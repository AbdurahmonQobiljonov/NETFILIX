                                    ...
                                    <div className="col-xl-6 col-lg-12 col-md-12">
                                        ...
                                        <div className="trending-list" data-animation-in="fadeInUp" data-delay-in="1.2">
                                            <div className="text-primary title starring">
                                                Starring :
                                                <span
                                                    className="text-body">Robert Downey Jr., Chris Evans, Mark Ruffalo</span>
                                            </div>
                                    ...
                                    <div className="col-xl-6 col-lg-12 col-md-12">
                                        ...
                                        <div className="trending-list" data-animation-in="fadeInUp" data-delay-in="1.2">
                                            <div className="text-primary title starring">
                                                Starring :
                                                <span
                                                    className="text-body">Kristan Bell, Idina menzel, Jonathan Groff</span>
                                            </div>
                                            <div className="text-primary title genres">
                                            ...
                                            <div className="text-primary title tag">
                                                Tags :
                                                <span className="text-body">Animation, Adventure, Comedy</span>
                                            </div>
                                        </div>
                                        <div className="d-flex align-items-center r-mb-23 mt-4"
                                             data-animation-in="fadeInUp"
                                    ...
                                    <div className="col-xl-6 col-lg-12 col-md-12">
                                        ...
                                        <div className="trending-list" data-animation-in="fadeInUp" data-delay-in="1.2">
                                            <div className="text-primary title starring">
                                                Starring :
                                                <span
                                                    className="text-body">Patrick Wilson, Vera Farminga, Ron Livingston</span>
                                            </div>
                                            <div className="text-primary title genres">
                                            ...
                                            <div className="text-primary title tag">
                                                Tags :
                                                <span className="text-body">Horror, Mystery, Thriller</span>
                                            </div>
                                        </div>
                                        <div className="d-flex align-items-center r-mb-23 mt-4"
                                             data-animation-in="fadeInUp"
